...
ITensor HaagerupQSite::qar(int i, int j) const {
    ...
    if (i==1) {
        if (j==1) {
            ...
            Op.set(s(1),sP(4),-0.018511383658106454101);
            Op.set(s(2),sP(2),0.033641737525777182951);
            Op.set(s(2),sP(5),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(3),sP(3),0.033641737525777182951);
            Op.set(s(3),sP(6),0.060086520514318956543-0.011295171033667085220 * 1_i);

            Op.set(s(4),sP(1),-0.018511383658106454101);
            Op.set(s(4),sP(4),0.23240812075600178448);
            Op.set(s(5),sP(2),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(5),sP(5),1.0/3);
            Op.set(s(6),sP(3),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(6),sP(6),1.0/3);
        }else if (j==2) {
            Op.set(s(1),sP(3),0.033641737525777182951);
            Op.set(s(1),sP(6),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(2),sP(1),0.033641737525777182951);
            Op.set(s(2),sP(4),-0.018511383658106454101);
            Op.set(s(3),sP(2),0.033641737525777182951);
            Op.set(s(3),sP(5),0.060086520514318956543+0.011295171033667085220 * 1_i);

            Op.set(s(4),sP(3),-0.018511383658106454101);
            Op.set(s(4),sP(6),-0.069884694667841266411-0.098617145928255533092 * 1_i);
            Op.set(s(5),sP(1),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(5),sP(4),-0.069884694667841266411-0.098617145928255533092 * 1_i);
            Op.set(s(6),sP(2),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(6),sP(5),0.19023199562434830725+0.10983049388219720574 * 1_i);
        }else if (j==3) {
            Op.set(s(1),sP(2),0.033641737525777182951);
            Op.set(s(1),sP(5),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(2),sP(3),0.033641737525777182951);
            Op.set(s(2),sP(6),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(3),sP(1),0.033641737525777182951);
            Op.set(s(3),sP(4),-0.018511383658106454101);

            Op.set(s(4),sP(2),-0.018511383658106454101);
            Op.set(s(4),sP(5),-0.069884694667841266411+0.098617145928255533092 * 1_i);
            Op.set(s(5),sP(3),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(5),sP(6),0.19023199562434830725-0.10983049388219720574 * 1_i);
            Op.set(s(6),sP(1),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(6),sP(4),-0.069884694667841266411+0.098617145928255533092 * 1_i);
        }
    }else if (i==2) {
        if (j==1) {
            Op.set(s(1),sP(3),0.033641737525777182951);
            ...
            Op.set(s(4),sP(2),-0.018511383658106454101);
            Op.set(s(4),sP(5),0.04058147137493685721-0.21587981315230614174 * 1_i);
            Op.set(s(5),sP(3),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(5),sP(6),-0.069884694667841266411+0.098617145928255533092 * 1_i);
            Op.set(s(6),sP(1),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(6),sP(4),0.04058147137493685721-0.21587981315230614174 * 1_i);
        }else if (j==3) {
            Op.set(s(1),sP(1),0.033641737525777182951);
            Op.set(s(1),sP(4),-0.018511383658106454101);
            Op.set(s(2),sP(2),0.033641737525777182951);
        ...
        if (j==1) {
            ...
            Op.set(s(4),sP(3),-0.018511383658106454101);
            Op.set(s(4),sP(6),0.04058147137493685721+0.21587981315230614174 * 1_i);
            Op.set(s(5),sP(1),0.060086520514318956543-0.011295171033667085220 * 1_i);
            Op.set(s(5),sP(4),0.04058147137493685721+0.21587981315230614174 * 1_i);
            Op.set(s(6),sP(2),0.060086520514318956543+0.011295171033667085220 * 1_i);
            Op.set(s(6),sP(5),-0.069884694667841266411-0.098617145928255533092 * 1_i);
        }
    }
    return Op;
}
...
//            ampo += 3*Mj,"m1",j,"m5",mod(j+1, num_sites),"m6",mod(j+2, num_sites);
//            ampo += 3*Mj,"m1",j,"m6",mod(j+1, num_sites),"m5",mod(j+2, num_sites);
//            ampo += 3*Mj,"m2",j,"m4",mod(j+1, num_sites),"m6",mod(j+2, num_sites);
//            ampo += 3*Mj,"m2",j,"m5",mod(j+1, num_sites),"m5",mod(j+2, num_sites);
//            ampo += 3*Mj,"m2",j,"m6",mod(j+1, num_sites),"m4",mod(j+2, num_sites);
//            ampo += 3*Mj,"m3",j,"m4",mod(j+1, num_sites),"m5",mod(j+2, num_sites);
//            ampo += 3*Mj,"m3",j,"m5",mod(j+1, num_sites),"m4",mod(j+2, num_sites);
//            ampo += 3*Mj,"m3",j,"m6",mod(j+1, num_sites),"m6",mod(j+2, num_sites);
//
...
//            ampo += 3*Mj,"m5",j,"m4",mod(j+1, num_sites),"m3",mod(j+2, num_sites);
//            ampo += 3*Mj,"m5",j,"m5",mod(j+1, num_sites),"m2",mod(j+2, num_sites);
//            ampo += 3*Mj,"m5",j,"m6",mod(j+1, num_sites),"m1",mod(j+2, num_sites);
//            ampo += 3*Mj,"m6",j,"m4",mod(j+1, num_sites),"m2",mod(j+2, num_sites);
//            ampo += 3*Mj,"m6",j,"m5",mod(j+1, num_sites),"m1",mod(j+2, num_sites);
//            ampo += 3*Mj,"m6",j,"m6",mod(j+1, num_sites),"m3",mod(j+2, num_sites);
